...
if ($result->num_rows > 0) {
                                      ...
                                      while($row = $result->fetch_assoc()) {
                                          if($row["admin_id"]==$_POST["admin"] && $row["password"]==$_POST["pass"])
                                          {
...
if ($flag==1) {
    header("location: http://localhost:8000/dbms/project/www/admin.php");
}
$conn->close();?>
<!DOCTYPE html>
<html>
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form action="adminlog.php" method="post">
      <input type="text"  class="fadeIn second" name="admin" placeholder="login">
