...
<?php
	if(isset($type))
	{
    $sql2="SELECT * from customer_login";
...
<body style="background-repeat: no-repeat; background-size: cover; background-position: center center;background-image :www\img\bg.jpg">
    ...
    <nav class="navbar navbar-expand-sm bg-light navbar-light sticky-top">
        ...
        <a href="index.html"><button type="button" class="btn btn-outline-primary">HOME</button></a>
          <a href="admin.html"> <button type="button" class="btn btn-outline-secondary">ADMIN LOGIN</button></a>
          <a href="cuslog.html"><button type="button" class="btn btn-outline-success">CUSTOMER LOGIN</button></a>
          <button type="button" class="btn btn-outline-danger">ROOMS</button>
    ...
    ?>
        <form id="contact" action="cusform.php" method="post">
        <font color="black"><h3>Customer Details From</h3></font>
          ...
          <fieldset>
            <input placeholder="Customer Phone Number" type="tel" tabindex="3" name="tel" required>
          </fieldset>
          <fieldset>
            <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Submit</button>
          </fieldset>
           <?php
           if(isset($type) && isset($pass))
      echo "c_id  ".$type."  password ".$pass."  ";
		    ?>
        </form>
      </div>
</body>
