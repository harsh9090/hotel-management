...
if(isset($_POST["login"]) && isset($_POST["login_p"]))
{
...
if ($result->num_rows > 0) {
                                      ...
                                      while($row = $result->fetch_assoc()) {
                                          if($row["c_id"]==$_POST["login"] && $row["password"]==$_POST["login_p"])
                                          {
...
if ($flag==1) {
    header("location: http://localhost:8000/dbms/project/www/customer.html");
}
$conn->close();
}?>
<!DOCTYPE html>
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form action="cuslog.php" method="post">
      ...
      <input type="text" id="password" class="fadeIn third" name="login_p" placeholder="password">
      <input type="submit" class="fadeIn fourth" value="Log In">
      <a href="cusform.php"><input type="button" class="fadein fourth" value="sign up"></a>
    </form>
  </div>
</div>
end
