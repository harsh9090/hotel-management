...
<body>
    ...
    <div class="container">  
        ...
        <form id="contact" action="employeed.php" method="post">
        <font color="black"><h3>Employee Details From</h3></font>
          <fieldset>
            <input placeholder="employee id" name="e_id" type="text" tabindex="1"  required autofocus>
          </fieldset>
          <fieldset align=left>
                <input placeholder="new salary" name="e_salary" type="number" tabindex="3" required>
              </fieldset>
          <fieldset>
        ...
        $type=$_POST["e_id"];
        $price=$_POST["e_salary"];
        
        $sql = "UPDATE employee SET emp_sal=$price WHERE emp_id=$type";
