...
<body style="background-repeat: no-repeat; background-size: cover; background-position: center center;background-image :www\img\bg.jpg">
    ...
    <div class="container">  
        ...
        <form id="contact" action="editr.php" method="post">
        <font color="black"><h3>Rooms Details From</h3   ></font>
          <fieldset>
            <input placeholder="room type" name="r_type" type="text"  required autofocus>
          </fieldset>
          <fieldset align=left>
            <input placeholder="new price"  type="number" tabindex="2" name="new_p">
          </fieldset>
          <fieldset>
...
$sql1 ="SELECT type from r_cost";
$sql = "UPDATE r_cost SET cost=$price WHERE type='$type'";
